...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1> Livros </h1><table id=\"livros\"><tr><td>ID</td><td>Titulo</td><td>Preço</td></tr>");
  ...
  out.w("</table><input type=\"submit\" value=\"Novo livro\" onclick=\"window.location='/livros/form'\"><script src=\"/estatico/js/remove-livro.js\">\r\n        </script>");
